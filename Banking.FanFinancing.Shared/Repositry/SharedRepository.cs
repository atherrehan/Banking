...
namespace Banking.FanFinancing.Shared.Repositry
{
    public class SharedRepository : ISharedRepository
    {
        ...
        //{
        //    //ApiUrl? url = await _dbContext.GetURL("Nadra");//In case Rest 
        //    ApiUrl? url = await _dbContext.GetURL("Nadra_Soap");
        ...
        //        };
        //        response.ResponseData.PersonData = new()
        //        {
        //            BirthPlace = "لاہور,لاہور",
        //            DateOfBirth = "07-12-1999",
        //            ExpiryDate = "2028-07-16",
        //            FatherHusbandName = "طارق محمود",
        //            MotherName = "روبینہ کوثر",
        //            Name = "محمد اسامہ",
        //            PermanantAddress = "مکان نمبر 5،گلی نمبر 12،محلہ مصطفےٰ آباد دھرم پورہ،لاہور کینٹ،ضلع لاہور",
        //            Photograph = "",
        //            PresentAddress = "مکان نمبر A-70،محلہ علامہ اقبال ٹاؤن،بلاک پاک،لاہور"
        //        };
        //        response.ResponseData.ResponseStatus = new()
        //        {
        //            Code = "100",
        //            Message = "Static/Mock result is returned."
        //        };
        ...
        //    url.Soap = url.Soap.Replace("{TRANSACTION_ID}", apiRequest.TransactionId);
        //    url.Soap = url.Soap.Replace("{SESSION_ID}", apiRequest.SessionId);
        //    url.Soap = url.Soap.Replace("{CITIZEN_NUMBER}", apiRequest.CitizenNumber);
        //    url.Soap = url.Soap.Replace("{AREA_NAME}", apiRequest.AreaName);
        //    url.Soap = url.Soap.Replace("{ISSUE_DATE}", apiRequest.IssueDate);
        //    url.Soap = url.Soap.Replace("{BIRTH_YEAR}", apiRequest.BirthYear);
